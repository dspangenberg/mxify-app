...
export const FormCard: React.FC<FormCardProps> = ({
  ...
  return (
    <div className={cn('mx-auto flex h-full w-full flex-1 flex-col overflow-hidden', className)}>
      <div className="relative flex max-h-fit flex-1 flex-col gap-1.5 overflow-hidden rounded-lg border border-border/80 bg-page-content p-1.5">
        ...
        {footer && (
          <div className={cn('flex w-full flex-none items-center justify-end px-4 py-1.5', footerClassName)}>
            {footer}
          </div>
        )}
      </div>
